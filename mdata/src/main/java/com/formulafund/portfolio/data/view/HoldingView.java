...
public class HoldingView implements Comparable<HoldingView> {
	...
	public boolean isFilledIn() {
		...
		if (this.portfolioName == null) return false;
	...
	public HoldingView deepCopy() {
		...
		another.setPortfolioName(this.getPortfolioName());
	...
	public String toString() {
		return "HoldingView [accountName=" + accountName + ", userName=" + userName + ", portfolioName=" + portfolioName
	...
	public int compareTo(HoldingView o) {
		...
		if (o.getPortfolioName() == null) return 1;
		...
		if (comparison != 0) return comparison;
		comparison = this.getPortfolioName().compareTo(o.getPortfolioName());
		if (comparison != 0) return comparison;
